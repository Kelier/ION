...
var ion = (function () {
    ...
    function FragmentBanner(option) {
        ...
        //容器将包容控制器
        this.container = '.ion-banner';

        //默认的控制器
        this.controller = {
            view: '.ion-banner-view',
            btn: '.ion-banner-btn',
            num: '.ion-banner-number',
            progre: '.ion-banner-progres'
        };
    ...
    FragmentBanner.prototype = {
        ...
        init: function () {
            ...
            var h = this.size.height / this.grid.line;
    ...
    var initBanner = function (options) {
        new FragmentBanner(options);
    };
